	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www6.53kf.com/webCompany.php?arg=9006234&style=10&kflist=off&kf=229117&zdkf_type=3&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.shjhome.com%2F15&keyword=&brief=&logo=&question=&uid=39e01823682ac408a282b016f232d523";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div class=\"Lelem\" id=\"acc_title\" style=\"    position: relative; z-index: 10000; cursor: pointer;\" maxwidth=\"400\" maxheight=\"400\" minwidth=\"100\" minheight=\"100\" operating=\"\"><div class=\"Lelem\" style=\"left: 0px; top: 0px; width: 400px; height: 240px; display: block; position: absolute; z-index: 10001; cursor: default;\" type=\"img\" eld_img=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070800.gif\"><img style=\"width: 400px; height: 240px;\" src=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070800.gif\"></div><div class=\"Lelem\" style=\"left: 41px; top: 193px; width: 88px; height: 28px; display: block; position: absolute; z-index: 10002; cursor: pointer;\" type=\"img\" operating=\"CLOSE\" eld_img=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070813.png\"><img style=\"width: 88px; height: 28px;\" src=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070813.png\"></div><div class=\"Lelem\" style=\"left: 156px; top: 193px; width: 88px; height: 28px; display: block; position: absolute; z-index: 10003; cursor: pointer;\" type=\"img\" operating=\"KF\" eld_img=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070813.png\"><img style=\"width: 88px; height: 28px;\" src=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070813.png\"></div><div class=\"Lelem\" style=\"left: 273px; top: 193px; width: 88px; height: 28px; display: block; position: absolute; z-index: 10004; cursor: pointer;\" type=\"img\" operating=\"KF\" eld_img=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070813.png\"><img style=\"width: 88px; height: 28px;\" src=\"http://www6.53kf.com/img/upload/9006234/zdypic/box_90062341415070813.png\"></div></div>";
			var is_autoyqk				= "1";
		...
		//	var acc_poptype			 = -1;
            ...
            if(1 == 1){
                ...
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:16px;overflow:hidden;position:absolute;top:7px;left:10px;width:330px;height:20px;color:'+font_color+';text-indent:30px;background:url(http://www6.53kf.com/style/chat/minichat2/img/minchat_ns_3.png) -79px 0 no-repeat;font-weight:bold;font-family:Arial;">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:10px;right:46px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/min.png?11) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:10px;right:28px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/maxto.gif) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:10px;right:10px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/minchat_ns_3.png) -18px 0 no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:400px;margin:0 2px;height:35px;background:url(http://www6.53kf.com/style/chat/minichat2/img/header_bg_3.png?111) no-repeat;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
                if(3 == 1){
                    tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:16px;overflow:hidden;position:absolute;top:7px;left:10px;width:330px;height:20px;color:#fff;text-indent:30px;background:url(http://www6.53kf.com/style/chat/minichat2/img/minchat_ns_3.png) -79px 0 no-repeat;font-weight:bold;font-family:Arial;">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:10px;right:46px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/min.png?11) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:10px;right:28px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/maxto.gif) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:10px;right:10px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/minchat_ns_3.png) -18px 0 no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:403px;height:35px;background:url(http://www6.53kf.com/style/chat/minichat2/img/header_bg_3.png?111) no-repeat;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
                }
            ...
            if(1 == 10) {
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:14px;  font-weight: bold;overflow:hidden;position:absolute;top:10px;left:20px;width:230px;height:18px;color:#525c63;text-indent:2px;font-family:微软雅黑,arial">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:1px;right:76px;width:39px;height:29px;background:url(http://www6.53kf.com/style/chat/minichat2/img/min_llt.png) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:1px;right:39px;width:37px;height:29px;background:url(http://www6.53kf.com/style/chat/minichat2/img/maxto_llt.png) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:1px;right:8px;width:31px;height:29px;background:url(http://www6.53kf.com/style/chat/minichat2/img/close_llt.png) no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:400px;height:41px;background:url(http://www6.53kf.com/style/chat/minichat2/img/header_bg_dz1.png) no-repeat; border-top-right-radius: 6px;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 12) {
             ...
             if(1 == 13) {
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="display:none;position:absolute;top:10px;left:20px;"></div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:16px;right:52px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/min13.png) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:12px;right:28px;width:13px;height:13px;background:url(http://www6.53kf.com/style/chat/minichat2/img/maxto13.png) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:12px;right:8px;width:12px;height:12px;background:url(http://www6.53kf.com/style/chat/minichat2/img/close13.png) no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="border: 1px solid #E2E2E2;border-top-right-radius: 5px;border-top-left-radius: 5px;width:278px;height:31px;background-color:#F1F1F1;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
			...
			{
				var openurl = "http://www6.53kf.com/webCompany.php?arg=9006234&style=10&kflist=off&kf=229117&zdkf_type=3&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.shjhome.com%2F15&keyword=&brief=&logo=&question=&uid=39e01823682ac408a282b016f232d523&tfrom=2"+force_kf;
				try{
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
                    ...
                    $53("mini_header_bg_div").style.backgroundImage = "url('http://www6.53kf.com/style/chat/minichat2/img/header_bg2_3.png')";
				}
				else
				{	
                   ...
                   $53("mini_header_bg_div").style.backgroundImage = "url('http://www6.53kf.com/style/chat/minichat2/img/header_bg_3.png')";
			...
			function hz6d_overTotalNum(type) {
                ...
                if(type == 'chat') {
                    if(acc_pop_total==1) {
					   var total_invite = $53.getCookie("invite_53kf_totalnum_10");
                ...
                if(type == 'ivt') {
                    if(ivt_pop_total==1) {	
					   var total_invite = $53.getCookie("invite_53kf_totalnum_10"+'ivt');
					   if(total_invite=="") { total_invite = 0; }
			...
			{
                var total_cookie_name = 'invite_53kf_totalnum_10';
                if(type == 'ivt'){
			...
			{
				if(ivt_zdfq == 'yes') {
					//document.cookie = "onliner_zdfq70831548="+onliner_zdfq;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						acpt_force_kf(force_kf);
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=3&interface_theme=1&minchat_style=1';
			...
			function close_company_mini(){	
                ...
                if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq70831548="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF': 
								case 'KF': var click_open_url = 'window.open(\"http://www6.53kf.com/webCompany.php?arg=9006234&style=10&kflist=off&kf=229117&zdkf_type=3&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.shjhome.com%2F15&keyword=&brief=&logo=&question=&uid=39e01823682ac408a282b016f232d523&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								click_open_url = encodeURIComponent(click_open_url);
								click_str ='onliner_zdfq=2;hz6d_is_exist(\"'+click_open_url+'\");hidden_ivt();';break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www6.53kf.com/webCompany.php?arg=9006234&style=10&kflist=off&kf=229117&zdkf_type=3&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.shjhome.com%2F15&keyword=&brief=&logo=&question=&uid=39e01823682ac408a282b016f232d523&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE': click_str = 'onliner_zdfq=3;hidden_ivt();'; break;
							case 'ETEL': click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=70831548&style_id=106124178\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
							case 'QQ': 
								if(valst[1])
								{
